...
class RuntimeContainer {
	...
	protected function get_core( string $class_name, array &$resolve_chain ) {
		...
		if ( ! $this->is_class_allowed( $class_name ) ) {
			throw new ContainerException( "Attempt to get an instance of class '$class_name', which is not in the " . self::GREATTRANSFER_NAMESPACE . ' namespace. Did you forget to add a namespace import?' );
		}
