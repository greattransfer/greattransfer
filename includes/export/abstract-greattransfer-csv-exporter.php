...
abstract class GreatTransfer_CSV_Exporter {
	...
	public function get_filename() {
		return sanitize_file_name( apply_filters( "gettransfer_{$this->export_type}_export_get_filename", $this->filename ) );
	}
	...
	protected function export_rows() {
		...
		return apply_filters( "gettransfer_{$this->export_type}_export_rows", ob_get_clean(), $this );
	}
	...
	public function get_limit() {
		return apply_filters( "gettransfer_{$this->export_type}_export_batch_limit", $this->limit, $this );
	}
