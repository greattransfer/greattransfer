...
class GreatTransfer_Admin_Importers {
	...
	public function post_importer() {
		...
		//  greattransfer_admin_record_tracks_event( 'post_importer_view_from_wp_importer' );
		// }
	...
	public function register_importers() {
		if ( defined( 'WP_LOAD_IMPORTERS' ) ) {
			...
			register_importer(
				...
				__( 'GreaTransfer posts (CSV)', 'greattransfer' ),
				__( 'Import <strong>posts</strong> to your site via a csv file.', 'greattransfer' ),
	...
	public function do_ajax_post_import() {
		if ( ! $this->import_allowed() ) {
			wp_send_json_error( array( 'message' => __( 'Insufficient privileges to import posts.', 'greattransfer' ) ) );
		}
	...
	public function track_importer_exporter_view() {
		...
		//  greattransfer_admin_record_tracks_event( 'wordpress_' . $screen->id . '_view' );
		// }
	}
}
