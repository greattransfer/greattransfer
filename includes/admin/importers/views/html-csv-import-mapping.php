...
?>
<form class="greattransfer-progress-form-content greattransfer-importer" method="post" action="<?php echo esc_url( $this->get_next_step_link() ); ?>">
	<header>
	...
	<section class="greattransfer-importer-mapping-table-wrapper">
		<table class="widefat greattransfer-importer-mapping-table">
			<thead>
				<tr>
					<th><?php esc_html_e( 'Column name', 'greattransfer' ); ?></th>
					<th><?php esc_html_e( 'Map to field', 'greattransfer' ); ?></th>
				</tr>
			</thead>
			<tbody>
					...
					<tr>
						<td class="greattransfer-importer-mapping-table-name">
							...
							<?php if ( ! empty( $sample[ $index ] ) ) : ?>
								<span class="description"><?php esc_html_e( 'Sample:', 'greattransfer' ); ?> <code><?php echo esc_html( $sample[ $index ] ); ?></code></span>
							<?php endif; ?>
						</td>
						<td class="greattransfer-importer-mapping-table-field">
							...
							<select name="map_to[<?php echo esc_attr( $index ); ?>]">
								<option value=""><?php esc_html_e( 'Do not import', 'greattransfer' ); ?></option>
								<option value="">--------------</option>
	...
	<div class="greattransfer-actions">
		<button type="submit" class="button button-primary button-next" value="<?php esc_attr_e( 'Run the importer', 'greattransfer' ); ?>" name="save_step"><?php esc_html_e( 'Run the importer', 'greattransfer' ); ?></button>
