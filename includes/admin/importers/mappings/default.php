...
add_filter( 'greattransfer_csv_product_import_mapping_default_columns', 'greattransfer_importer_default_english_mappings', 100 );
...
add_filter( 'greattransfer_csv_product_import_mapping_special_columns', 'greattransfer_importer_default_special_english_mappings', 100 );
